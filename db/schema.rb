...
ActiveRecord::Schema[8.0].define(version: 2026_09_14_120000) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "desktop_api_token_digest"
    t.datetime "desktop_api_token_expires_at"
    t.index ["desktop_api_token_digest"], name: "index_users_on_desktop_api_token_digest", unique: true
